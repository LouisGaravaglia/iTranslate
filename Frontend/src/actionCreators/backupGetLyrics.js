...
// ////////////////////////////////// GET ALL POSTS //////////////////////////////////
// export function findLyricsFromAPI(trackData, artistData, albumData, artist, track) {
//   //VARIBLE THAT KEEPS TRACK OF ANY ERROR REQUESTING LYRICS
//   let lyricsError = false;

//   const findLyricsAddToDatabase = async (trackData, artist, track) => {
//     //GET LYRICS FROM LYRICS API
//     const APILyrics = await LyricsAPI.getLyrics(artist, track);
//     console.log("APILyrics = ", APILyrics);
...
//     // const addMusicDataToDatabase = async (trackData, artistData, albumData, artist, track) => {
...
//         //EVEN IF WE ATTEMPTED TO ADD A TRACK THAL ALREADY EXISTS IN DATABASE
//         //WE WANT TO ATTEMPT TO GET LYRICS AGAIN IN CASE API HAS ADDED THEM
//         //AND OF COURSE IF WE ADD A NEW TRACK TO DATABASE, WE WANT TO ADD LYRICS IF POSSIBLE
//         try {
//           //ADD TRACK/ARTIST/ALBUM DATA TO BACKEND, IF NOT ALREADY THERE
//           const response = await BackendCall.addTrackArtistAlbum(trackData, artistData, albumData);
//           findLyricsAddToDatabase(trackData, artist, track);
//         } catch(e) {
//           lyricsError = true;
//           dispatch(updateLyricsError(lyricsError));
//         }
